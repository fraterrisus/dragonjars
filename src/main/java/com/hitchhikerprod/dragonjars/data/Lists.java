...
public class Lists {
    public static final String[] MAP_NAMES = {
            "Dilmun", "Purgatory", "Slave Camp", "Guard Bridge #1", "Salvation", "Tars Ruins", "Phoebus",
            "Guard Bridge #2", "Mud Toad", "Byzanople", "Smugglers Cove", "War Bridge", "Scorpion Bridge",
            "Bridge of Exiles", "Necropolis", "Dwarf Ruins", "Dwarf Clan Hall", "Freeport", "Magan Underworld",
            "Slave Mines", "Lansk", "Sunken Ruins Above", "Sunken Ruins Below", "Mystic Wood", "Snake Pit", "Kingshome",
            "Pilgrim Dock", "Depths of Nisir", "Old Dock", "Siege Camp", "Game Preserve", "Magic College",
            "Dragon Valley", "Phoebus Dungeon", "Lanac'toor's Lab", "Byzanople Dungeon", "Kingshome Dungeon",
